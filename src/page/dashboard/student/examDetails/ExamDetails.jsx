...
import SolutionPdf from "../../../../components/studentDashboard/examDetails/SolutionPdf";
import MathPracticeSession from "../../../../components/studentDashboard/examDetails/MathPracticeSession";
import Leaderboard from "../../../../components/studentDashboard/examDetails/Leaderboard";
...
function ExamDetails() {
  ...
  return (
    <div className="w-full flex flex-col gap-6 text-slate-800 font-sans pb-10">
