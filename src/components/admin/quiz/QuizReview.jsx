    ...
    try {
      if (updatedQuestion.id === "new") {
        ...
        const payload = {
          ...
          steps: updatedQuestion.solution
            ? updatedQuestion.solution.split("\n")
            : [],
        ...
        const newMappedQ = {
          ...
          correctAnswer:
            result.correct_answer !== undefined ? result.correct_answer - 1 : 0,
          solution: Array.isArray(result.steps)
            ? result.steps.join("\n")
            : result.steps || "",
        };
          ...
          <div className="flex flex-col text-left">
            ...
            <div className="flex flex-wrap items-center mt-3 pt-3 border-t border-slate-100 text-left gap-y-2 w-full">
              <div className="flex flex-col pr-6 border-r border-slate-200 max-w-[320px]">
                ...
                <span
                  className="text-[#0A2648] font-bold text-sm mt-0.5 truncate"
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
              ...
              <div className="bg-[#FAFBFD] border border-slate-100 rounded-xl p-5 flex flex-col gap-2 h-full text-left">
                <span className="text-sm font-bold text-slate-700 lato">
                  Solution:
                </span>
