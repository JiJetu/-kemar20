  ...
  return (
    <div className="flex flex-col gap-4 animate-in fade-in duration-300">
      ...
      <button
        type="button"
        onClick={handleNext}
        className="w-full bg-[#39842B] hover:bg-[#39842B]/95 text-white py-3.5 mt-2 rounded-[8px] font-bold text-sm tracking-wider transition-all flex items-center justify-center gap-1.5 active:scale-[0.98] roboto"
      >
        <span>Next</span>
