    ...
    <div className="flex flex-col gap-4 animate-in fade-in duration-300">
      ...
      <div className="flex items-center gap-4 w-full">
        <button
          ...
          onClick={handleBack}
          disabled={isLoading}
          className="flex-1 border border-slate-200 text-[#082042] hover:bg-slate-50 py-3.5 rounded-[8px] font-bold text-sm transition-all flex items-center justify-center gap-1 active:scale-[0.98] disabled:opacity-50 roboto"
        >
          ← Back
        </button>
        <button
          ...
          disabled={isLoading}
          className="flex-1 bg-[#39842B] hover:bg-[#39842B]/95 text-white py-3.5 rounded-[8px] font-bold text-sm transition-all flex items-center justify-center gap-1.5 active:scale-[0.98] disabled:opacity-75 roboto"
        >
