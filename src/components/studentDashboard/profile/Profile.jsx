...
const Profile = () => {
  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 py-8 flex flex-col gap-8 text-slate-800 select-none">
      {/* Page Title & Subtitle */}
      ...
      <div className="bg-white border border-slate-200 rounded-[20px] p-6 sm:p-8 flex flex-col md:flex-row items-center gap-8 shadow-md relative">
        ...
        {!isEditing ? (
          <button
            ...
            className="absolute top-4 right-4 sm:top-6 sm:right-6 border border-[#5D9E32] text-[#5D9E32] hover:bg-[#5D9E32]/10 transition-all rounded-[10px] px-3.5 py-1.5 flex items-center gap-1.5 text-xs font-bold bg-white"
          >
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            <img
              src={profileImage}
              alt="User profile"
              className="w-28 h-28 sm:w-32 sm:h-32 rounded-full object-cover border-2 border-slate-200 shadow-md"
            />
            {isEditing && (
              <label
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className={`w-full bg-slate-50 border rounded-xl pl-12 pr-4 py-3 text-sm text-slate-800 focus:outline-none transition-all placeholder-slate-400 font-medium ${
                  isEditing
                    ? "focus:border-[#5D9E32] border-slate-300 bg-white"
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-6 justify-between">
          ...
          <div className="flex items-center w-full md:w-auto justify-end gap-6 border-t border-slate-100 md:border-t-0 pt-4 md:pt-0 shrink-0">
            ...
            <button
              ...
              className="border border-slate-200 hover:border-[#5D9E32] text-[#5D9E32] hover:bg-[#5D9E32]/5 transition-all rounded-[10px] px-4 py-2.5 flex items-center gap-2 text-sm font-semibold bg-white"
            >
          ...
          <div className="flex items-center gap-6 shrink-0">
            ...
            <button
              ...
              className={`w-14 h-7 rounded-full p-1 flex items-center cursor-pointer transition-colors shadow-inner ${
                emailNotifications ? "bg-[#5D9E32]" : "bg-slate-200 border border-slate-300"
              }`}
            >
              <div
      ...
      {isEditing && (
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full">
          ...
          <button
            ...
            className="bg-[#f4f2ee] hover:bg-[#e7e5e0] text-slate-800 border border-slate-200 font-bold py-3.5 px-8 rounded-xl shadow-md transition-all text-center w-full sm:flex-1 text-sm tracking-wide"
          >
            Cancel
          </button>
        </div>
      ...
      <div className="bg-white border border-slate-200 rounded-[20px] p-6 shadow-md flex flex-col divide-y divide-slate-100 text-left">
        ...
        <button
          ...
          className="flex items-center justify-between py-4 first:pt-0 last:pb-0 hover:bg-slate-50 transition-all rounded-lg px-2 w-full text-left"
        >
        ...
        <button
          ...
          className="flex items-center justify-between py-4 last:pb-0 hover:bg-red-50 transition-all rounded-lg px-2 w-full text-left"
        >
          <div className="flex items-center gap-4">
